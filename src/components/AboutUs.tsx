    ...
    <section id="about" className="section-y">
      <div className="section-padding max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            <div className="rounded-3xl bg-secondary aspect-[4/3] flex items-center justify-center relative overflow-hidden">
              <div className="absolute inset-0 bg-gradient-to-br from-primary/5 to-accent/10" />
              <div className="relative text-center p-8">
                <span className="font-display text-8xl text-primary/10">EU</span>
                <p className="font-body text-sm text-muted-foreground mt-4">
                  {t('Foto de equipa — em breve', 'Team photo — coming soon')}
                </p>
              </div>
            </div>
          </motion.div>
